    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_employee_id', models.ForeignKey(blank=True, help_text='Employee who will cover during this leave period', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='covering_leave_requests', to='employee.employee', verbose_name='Cover Employee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exclude_weekends', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], default='no', max_length=30, verbose_name='Exclude Weekends')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_employee_id', models.ForeignKey(blank=True, db_constraint=False, help_text='Employee who will cover during this leave period', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='employee.employee', verbose_name='Cover Employee')),
