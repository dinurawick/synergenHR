      ...
      success: (response) => {
        ...
        if (joined_employees.length != 0) {
          ...
          $.each(joined_employees, function (key, value) {
            ...
            elem = `<li class='employee_id' style="cursor: pointer; padding: 8px 12px; margin: 4px 0; background: #f8f9fa; border-radius: 6px; border-left: 4px solid #7fb069; transition: all 0.2s ease; font-size: 14px;" data-id=${id} onmouseover="this.style.background='#e9ecef'" onmouseout="this.style.background='#f8f9fa'"> 
              <i class="fas fa-user" style="color: #7fb069; margin-right: 8px;"></i>${value.employee_name} 
            </li>`;
