    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.CharField(blank=True, max_length=50, null=True, verbose_name='Branch (Legacy)')),
                ...
                ('any_other_code1', models.CharField(blank=True, max_length=50, null=True, verbose_name='Bank Code #1')),
                ('any_other_code2', models.CharField(blank=True, max_length=50, null=True, verbose_name='Bank Code #2')),
                ('additional_info', models.JSONField(blank=True, null=True)),
                ('bank', models.ForeignKey(blank=True, help_text='Select bank from registry', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='employee_bank_details', to='employee.bank', verbose_name='Bank')),
                ('bank_branch', models.ForeignKey(blank=True, help_text='Select branch from registry', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='employee_bank_details', to='employee.bankbranch', verbose_name='Branch')),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
